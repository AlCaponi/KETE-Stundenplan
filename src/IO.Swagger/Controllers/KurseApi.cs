...
{ 
    ...
    /// </summary>
    [ApiController]
    public class KurseApiController : ControllerBase
    { 
        /// <summary>
        /// Löschen
        /// </summary>
        ...
        [Route("//Kurse")]
        [ValidateModelState]
        [SwaggerOperation("KurseDelete")]
        public virtual IActionResult KurseDelete([FromHeader]string classID)
        { 
        ...
        [Route("//Kurse")]
        [ValidateModelState]
        [SwaggerOperation("KurseGet")]
        [SwaggerResponse(statusCode: 200, type: typeof(Course), description: "Successful operation")]
        public virtual IActionResult KurseGet()
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Course));
            string exampleJson = null;
            exampleJson = "{\n  \"id\" : 12\n}";
            
                        var example = exampleJson != null
                        ? JsonConvert.DeserializeObject<Course>(exampleJson)
                        : default(Course);            //TODO: Change the data returned
        ...
        [Route("//Kurse")]
        [ValidateModelState]
        [SwaggerOperation("KursePost")]
        [SwaggerResponse(statusCode: 200, type: typeof(ModelClass), description: "Successful operation")]
        public virtual IActionResult KursePost([FromBody]ModelClass body)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
        ...
        /// Aktualisieren
        /// </summary>
        /// <remarks>Um einen bestehenden Kurs zu aktualisieren muss die entsprechende ID mitgeliefert werden</remarks>
        /// <param name="body">Update eines existierenden Kurses in der Schule</param>
        /// <response code="200">Successful operation</response>
        ...
        [Route("//Kurse")]
        [ValidateModelState]
        [SwaggerOperation("KursePut")]
        [SwaggerResponse(statusCode: 200, type: typeof(Course), description: "Successful operation")]
        public virtual IActionResult KursePut([FromBody]Course body)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(Course));
