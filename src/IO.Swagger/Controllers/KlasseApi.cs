...
{ 
    ...
    /// </summary>
    [ApiController]
    public class KlasseApiController : ControllerBase
    { 
        /// <summary>
        /// Löschen
        /// </summary>
        ...
        [Route("//Klasse")]
        [ValidateModelState]
        [SwaggerOperation("KlasseDelete")]
        public virtual IActionResult KlasseDelete([FromHeader]string classID)
        { 
        ...
        [Route("//Klasse")]
        [ValidateModelState]
        [SwaggerOperation("KlassePost")]
        [SwaggerResponse(statusCode: 200, type: typeof(ModelClass), description: "Successful operation")]
        public virtual IActionResult KlassePost([FromBody]ModelClass body)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(ModelClass));
        ...
        [Route("//Klasse")]
        [ValidateModelState]
        [SwaggerOperation("KlassePut")]
        [SwaggerResponse(statusCode: 200, type: typeof(ModelClass), description: "Successful operation")]
        public virtual IActionResult KlassePut([FromBody]ModelClass body)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(200, default(ModelClass));
